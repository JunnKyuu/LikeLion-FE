...
const resultList = [
  ...
  {
    name: "간결하고 가독성이 높은 코드를 선호하며 데이터 분석이나 인공지능에 관심이 있는 사람 <Python>",
  ...
  {
    name: "하드웨어 제어나 성능 최적화에 관심이 있으며 저수준의 프로그래밍을 선호하는 사람 <C++>",
  ...
  {
    name: "iOS 앱 개발에 관심이 있으며 혁신적인 기술을 적용하고자 하는 사람 <Swift>",
  ...
  {
    name: "Android 앱 개발, 서버 개발에 관심이 있고 모던한 언어를 선호하는 사람 <Kotlin>",
  ...
  {
    name: "데이터베이스 관리 및 조작에 관심이 있는 사람 <SQL>",
